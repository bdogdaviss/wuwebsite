...
// ../../packages/ui-tamagui/src/tokens/discord.ts
var discordColors = {
  ...
  channelHover: "#38393b",
  // Sidebar row hover
  channelActive: "#404249",
  // Sidebar row active/selected
...
// ../../packages/ui-tamagui/src/tamagui.config.ts
...
var bodyFont = createInterFont(
  ...
  {
    sizeLineHeight: /* @__PURE__ */ __name((size2) => size2 + 6, "sizeLineHeight")
  }
);
var discordDark = {
